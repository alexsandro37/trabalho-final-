...
public class CandidaturasPanel extends javax.swing.JPanel {
    ...
    public CandidaturasPanel() {
        ...
        lblCandidato.setVisible(admin);
        cmbCandidato.setVisible(admin);
        lblVaga.setVisible(admin);
        cmbVaga.setVisible(admin);
        btnCadastrar.setVisible(admin);
        btnEditar.setVisible(admin);
        btnExcluir.setVisible(admin);
        btnLimpar.setVisible(admin);

        if (SessaoUsuario.isCandidato()) {
            lblCabecalho.setText("Minhas Candidaturas");
        } else if (SessaoUsuario.isEmpresa()) {
            lblCabecalho.setText("Candidaturas Recebidas");
        }
