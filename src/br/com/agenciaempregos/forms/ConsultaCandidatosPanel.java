...
public class ConsultaCandidatosPanel extends javax.swing.JPanel {
    ...
    public ConsultaCandidatosPanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblCabecalho.setText("Consulta de Candidatos");
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String areaFiltro = (String) cmbArea.getSelectedItem();
        for (br.com.agenciaempregos.model.Candidato c : br.com.agenciaempregos.dao.CandidatoDAO.listar()) {
            boolean passaTexto = texto.isEmpty() || c.getNome().toLowerCase().contains(texto.toLowerCase());
            boolean passaArea = areaFiltro == null || areaFiltro.equals("Todas") || c.getArea().equalsIgnoreCase(areaFiltro);
            if (passaTexto && passaArea) {
